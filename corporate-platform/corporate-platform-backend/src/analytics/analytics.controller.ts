...
import { RetirementAggregationService } from './services/retirement-aggregation.service'; // ◄ Fixed Import Placement
...
export class AnalyticsController {
  constructor(
    ...
    private retirementAggregationService: RetirementAggregationService, // ◄ Fixed DI Placement
  ) {}
